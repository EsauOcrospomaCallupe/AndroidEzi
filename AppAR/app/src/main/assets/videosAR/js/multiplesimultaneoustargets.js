var World = {
    ...
    createOverlays: function () {
         ...
         */
        var targetCollectionResource = new AR.TargetCollectionResource("assets/test.wtc");
    ...
    worldLoaded: function worldLoadedFn() {
        ...
        document.getElementById('loadingMessage').innerHTML =
            "<div" + cssDivInstructions + ">Busca las siluetas:</div>" +
            "<div" + cssDivTyrannosaurus + "><img src='assets/busdino.png'></div>" +
            "<div" + cssDivTriceratops + "><img src='assets/busoso.png'></div>" +
            "<div" + cssDivSpinosaurus + "><img src='assets/buslobochusco.png'></div>" +
            "<div" + cssDivDiplodocus + "><img src='assets/buscachalote.png'></div>";
    }
};
