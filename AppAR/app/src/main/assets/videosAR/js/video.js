var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		this.targetCollectionResource = new AR.TargetCollectionResource("assets/videoar.wtc", {
		});
		...
		*/
		...
		var imgOne = new AR.ImageResource("assets/busoso.png");
		var overlayOne = new AR.VideoDrawable("assets/videooso.mp4", 0.40, {
            translate: {
                y: -0.3
            }
        });
		...
		*/
		var imgTwo = new AR.ImageResource("assets/busdino.png");
		var overlayTwo = new AR.VideoDrawable("assets/videodino.mp4", 0.40, {
             translate: {
                 y: -0.3
             }
         });
	...
	worldLoaded: function worldLoadedFn() {
		...
		document.getElementById('loadingMessage').innerHTML =
			...
			"<div" + cssDivSurfer + "><img src='assets/busoso.png'></img></div>" +
			"<div" + cssDivBiker + "><img src='assets/busdino.png'></img></div>";
	}
};
