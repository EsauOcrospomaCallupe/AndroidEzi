var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		this.targetCollectionResource = new AR.TargetCollectionResource("assets/zvideo.wtc", {
		...
		*/
		var video = new AR.VideoDrawable("assets/videodino.mp4", 0.80, {
			translate: {
				y: -0.8
			}
		});
	...
	worldLoaded: function worldLoadedFn() {
		...
		document.getElementById('loadingMessage').innerHTML =
            "<div" + cssDivInstructions + ">Busca las siluetas &#35;1 (Dino) or &#35;2 (oso):</div>" +
            "<div" + cssDivSurfer + "><img src='assets/busdino.png'></img></div>" +
            "<div" + cssDivBiker + "><img src='assets/busoso.png'></img></div>";
	}
};
